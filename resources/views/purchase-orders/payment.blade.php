<x-app-layout>
    <div class="content">
        <x-content-header :isIndex="false" title="Update Pembayaran"
        ...
        <form action="{{ route('purchase-orders.payment.update', $purchaseOrder) }}" method="POST"
            ...
            <div class="space-y-6 p-6">
                ...
                <div>
                    ...
                    <select name="payment_method" class="input mt-2" required>
                ...
                <div>
                    ...
                    <input type="text" name="amount" inputmode="numeric" class="input mt-2"
                        value="{{ old('amount') }}" placeholder="contoh: 500000"
                ...
                <div>
                    ...
                    <input type="date" name="payment_date" class="input mt-2"
                ...
                <div x-data="{ fileName: '' }">
                    ...
                    <div
                        class="mt-2 rounded-2xl border-2 border-dashed border-slate-300 bg-slate-50 p-8 dark:border-slate-700 dark:bg-slate-900">
                        <div class="text-center">
                            <div
                                class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-100 text-emerald-600 dark:bg-emerald-900/20 dark:text-emerald-400">
                                <i class="fa-solid fa-file-arrow-up text-lg"></i>
                            </div>

                            <label
                                class="inline-flex cursor-pointer items-center gap-2 rounded-xl bg-emerald-600 px-4 py-2 font-semibold text-white hover:bg-emerald-700">
                            ...
                            <p class="mt-3 text-sm text-slate-500"
                                x-text="fileName ? fileName : 'JPG, PNG, PDF (Maks 2MB)'">
                            </p>
                        </div>
                    </div>
