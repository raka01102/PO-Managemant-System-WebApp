...
<body class="flex h-screen overflow-hidden bg-slate-50 text-slate-900 antialiased dark:bg-slate-950 dark:text-slate-100">
    {{-- SIDEBAR --}}
    ...
    <div class="flex flex-1 flex-col overflow-hidden">
        ...
        <header
            ...
            <div class="flex items-center gap-4">
                ...
                <button @click="sidebarOpen = true"
                    class="flex h-10 w-10 items-center justify-center rounded-xl text-slate-500 transition-colors duration-200 hover:bg-slate-100 hover:text-slate-700 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-white lg:hidden">
            ...
            <div class="flex items-center gap-3">
                ...
                <button @click="toggleDarkMode()"
                    class="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-500 transition-colors duration-200 hover:bg-slate-100 hover:text-slate-700 dark:border-slate-700 dark:bg-slate-900 dark:text-yellow-400 dark:hover:bg-slate-800">
                    <i :class="darkMode ? 'fa-solid fa-sun' : 'fa-solid fa-moon'"></i>
                </button>

                {{-- PROFILE --}}
                <div
                    class="flex items-center gap-3 rounded-2xl border border-slate-200 bg-white px-3 py-2 dark:border-slate-700 dark:bg-slate-900">
                    ...
                    <div
                        class="flex h-10 w-10 items-center justify-center rounded-xl bg-primary-600 text-sm font-bold text-white">
        ...
        <div
            ...
            <x-nav-link href="{{ route('purchase-orders.index') }}" class="flex flex-col" :active="request()->routeIs('purchase-orders.index') ||
                request()->routeIs('purchase-orders.show') ||
                request()->routeIs('purchase-orders.edit') ||
                request()->routeIs('purchase-orders.payment') ||
                request()->routeIs('purchase-orders.shipping') ||
                request()->routeIs('purchase-orders.create')">
                <span>
